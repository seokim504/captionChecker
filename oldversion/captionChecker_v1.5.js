...
// var sshot5secLater = new Promise((resolve, reject) => {
//   setTimeout(function(){

//     screenshot('sshot_5sec_later.png', function(error, complete) {
//       if(error)
//         console.log("Screenshot failed", error);
//       else
//         console.log("5 seconds after the madatory code occurred.. Screenshot succeeded");
//       });

//     return 'sshot_5sec_later.png'
//   }, 5000);
// });

// var sshot10secLater = new Promise((resolve, reject) => {
//   setTimeout(function(){

//     screenshot('sshot_10sec_later.png', function(error, complete) {
//       if(error)
//         console.log("Screenshot failed", error);
//       else
//         console.log("10 seconds after the madatory code occurred.. Screenshot succeeded");
//       });

//     return 'sshot_10sec_later.png'
//   }, 10000);
// });
